...
const UI_VERSION='v2.0.14';
const MODERN_BUILD='2026-09-22-v2.0.14-share-links-1';
...
async function verifyBuild(){
  ...
  try{
    ...
    if(proof){proof.textContent=modern?'✓ v2.0.14 · SHARED CORE VERIFIED':'✓ LEGACY v8.9.3 VERIFIED';proof.classList.add('ok');}
    return true;
  }catch(e){

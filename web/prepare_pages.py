...
index=index.replace('<link rel="stylesheet" href="style.css?v=2.0.11-share-links-1">','<meta name="theme-color" content="#111111">\n  <meta name="apple-mobile-web-app-capable" content="yes">\n  <meta name="apple-mobile-web-app-status-bar-style" content="default">\n  <link rel="manifest" href="manifest.webmanifest">\n  <link rel="icon" href="app-icon.svg" type="image/svg+xml">\n  <link rel="stylesheet" href="style.css?v=2.0.11-share-links-1">')
needle='<script src="app.js?v=2.0.11-share-links-1"></script>'
replacement='<script src="simulation-core.js?v=2.0.11"></script>\n<script src="web-api.js?v=2.0.11"></script>\n<script src="pwa.js?v=2.0.11"></script>\n'+needle
